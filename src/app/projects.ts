...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'In development: program that accepts image input and creates a cross stitch pattern from it. Currently a data structure that holds cross stitch patterns by color per pixel, with methods to retrieve and change the pixel color data, and estimate thread needed. Using Spring Boot to interact with my H2 database of ~460 DMC thread colors. Currently working on deploying this database with AWS RDS.',
    hostedUrl: '',
